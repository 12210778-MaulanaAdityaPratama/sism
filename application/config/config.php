...
|
*/
$config['base_url'] = 'http://localhost/sism';
...
// $config['sess_driver'] = 'database'; // Sesuaikan dengan kebutuhan Anda
// $config['sess_cookie_name'] = 'ci_session';
// $config['sess_expiration'] = 7200; // Waktu kadaluarsa sesi dalam detik
// $config['sess_save_path'] = 'ci_sessions'; // Jika menggunakan database
/*
