<?php $this->load->view("warga/_partials/head.php") ?>
            ...
            <div id="layoutSidenav_content">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('warga/superbeme/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
    ...
    <option value="menunggu" <?php echo ($superbeme->status == 'menunggu') ? 'selected' : ''; ?>>Menunggu</option>
    <option value="surat selesai" <?php echo ($superbeme->status == 'surat selesai') ? 'selected' : ''; ?>>Surat Selesai</option>
    <option value="surat belum selesai" <?php echo ($superbeme->status == 'surat belum selesai') ? 'selected' : ''; ?>>Surat Belum Selesai</option>
</select>
  </div>
						
							<input class="btn btn-success" type="submit" name="btn" value="Save" />
                            <?php if ($superbeme->status == 'surat selesai'): ?>
    <div class="form-group mt-3">
    <a href="https://wa.me/<?php echo $superbeme->telp; ?>" target="_blank" class="btn btn-success">Hubungi via WhatsApp</a>
    </div>
<?php endif; ?>
						</form>
						<?php else: ?>
							<?php redirect('warga/superbeme'); ?>
<?php endif; ?>
