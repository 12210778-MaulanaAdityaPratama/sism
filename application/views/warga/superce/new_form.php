<?php $this->load->view("warga/_partials/head.php") ?>
            ...
            <div id="layoutSidenav_content">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('warga/superce/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
						...
						<!-- Note: atribut action dikosongkan, artinya action-nya akan diproses 
							...
							<option <?php if ($superce->warga_negara1 == 'WNI') { echo 'selected'; }?> value="WNI">WNI</option>
							<option <?php if ($superce->warga_negara1 == 'WNA') { echo 'selected'; }?> value="WNA">WNA</option>
								</select>
							...
							<option <?php if ($superce->warga_negara2 == 'WNI') { echo 'selected'; }?> value="WNI">WNI</option>
							<option <?php if ($superce->warga_negara2 == 'WNA') { echo 'selected'; }?> value="WNA">WNA</option>
								</select>
    ...
    <select name="status" id="status">
      <option value="menunggu" <?php echo ($superce->status == 'menunggu') ? 'selected' : ''; ?>>Menunggu</option>
    </select>
  </div>
