<?php $this->load->view("warga/_partials/head.php") ?>
    ...
    <option value="surat belum selesai" <?php echo ($superce->status == 'surat belum selesai') ? 'selected' : ''; ?>>Surat Belum Selesai</option>
</select>
  </div>
						
							<input class="btn btn-success" type="submit" name="btn" value="Save" />
                            <?php if ($superce->status == 'surat selesai'): ?>
    <div class="form-group mt-3">
    <a href="https://wa.me/<?php echo $superce->telp; ?>" target="_blank" class="btn btn-success">Hubungi via WhatsApp</a>
    </div>
<?php endif; ?>
						</form>
						<?php else: ?>
							<?php redirect('warga/superce'); ?>
<?php endif; ?>
