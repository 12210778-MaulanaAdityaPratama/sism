<?php $this->load->view("warga/_partials/head.php") ?>
            ...
            <div id="layoutSidenav_content">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('warga/sktm/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
   ...
   <select name="status" id="status">
    ...
    <option value="surat ditolak" <?php echo ($sktm->status == 'surat ditolak') ? 'selected' : ''; ?>>Surat Ditolak</option>
