<?php $this->load->view("rt/_partials/head.php") ?>
            ...
            <div id="layoutSidenav_content">
				...
				<div class="card mb-3">
					<div class="card-header">
						<a href="<?php echo site_url('rt/suratusaha/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
					</div>
					<div class="card mb-3">
    ...
    <option value="surat selesai" <?php echo ($suratusaha->status == 'surat selesai') ? 'selected' : ''; ?>>Surat Selesai</option>
    
</select>
  </div>
			
							<input class="btn btn-success" type="submit" name="btn" value="Save" />
							<?php if ($suratusaha->status == 'surat selesai'): ?>
    <div class="form-group mt-3">
    <!-- <a href="https://wa.me/<?php echo $suratusaha->telp; ?>" target="_blank" class="btn btn-success">Hubungi via WhatsApp</a> -->
	<a href="https://api.whatsapp.com/send?phone=+62<?php echo $sktm->telp; ?>&text=Halo%20<?php echo $suratusaha->nama; ?>%2CSurat%20Usaha%20telah%20selesai%20dibuat." target="_blank" class="btn btn-success">Hubungi via WhatsApp</a>
    </div>
<?php endif; ?>
						</form>
						<?php else: ?>
							<?php redirect('rt/suratusaha'); ?>
<?php endif; ?>
