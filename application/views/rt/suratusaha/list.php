<?php $this->load->view("rt/_partials/head.php") ?>
        ...
        <?php $this->load->view("rt/_partials/sidebar.php") ?>
            ...
            <div id="layoutSidenav_content">
                <main>
					...
					<form action="<?php echo site_url('rt/suratusaha/search') ?>" method="post">
						<input type="text" class="form-control" placeholder="Cari..." name="keyword">
						<div class="input-group-append">
							<input class="btn btn-primary" type="submit" name="submit" value="Search">
							<a class="btn btn-secondary" href="<?php echo site_url('rt/suratusaha') ?>">Reset</a>
						</div>
					</form>
					
				</div>
					<div class="card mb-3">
                    <a href="<?php echo site_url('rt/suratusaha/add') ?>"><i class="fas fa-plus"></i> Add New</a>
  ...
  <?php foreach ($suratusaha as $suratusaha): ?>
    ...
    <td>
                    ...
                    <td width="250">
											<a href="<?php echo site_url('rt/suratusaha/edit/'.$suratusaha->id) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											 <a href="<?php echo site_url('rt/suratusaha/delete/'.$suratusaha->id) ?>"
											 class="btn btn-small text-danger"><i class="fas fa-trash"></i> Delete</a>
                                             <a href="<?php echo site_url('rt/suratusaha/pdf/'.$suratusaha->id) ?>"
