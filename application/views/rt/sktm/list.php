<?php $this->load->view("rt/_partials/head.php") ?>
        ...
        <?php $this->load->view("rt/_partials/sidebar.php") ?>
            ...
            <div id="layoutSidenav_content">
                <main>
					...
					<form action="<?php echo site_url('rt/sktm/search') ?>" method="post">
						<input type="text" class="form-control" placeholder="Cari..." name="keyword">
						<div class="input-group-append">
							<input class="btn btn-primary" type="submit" name="submit" value="Search">
							<a class="btn btn-secondary" href="<?php echo site_url('rt/sktm') ?>">Reset</a>
						</div>
					</form>
					...
					<div class="card mb-3">
					<div class="card-body">
          <a href="<?php echo site_url('rt/sktm/add') ?>"><i class="fas fa-plus"></i> Add New</a>
  ...
  <?php foreach ($sktm as $sktm): ?>
    <tr>
                    ...
                    <td width="250">
											<a href="<?php echo site_url('rt/sktm/edit/'.$sktm->id) ?>"
											 class="btn btn-small"><i class="fas fa-edit"></i> Edit</a>
											 <a href="<?php echo site_url('rt/sktm/delete/'.$sktm->id) ?>"
											 class="btn btn-small text-danger"><i class="fas fa-trash"></i> Delete</a>
                       <a href="<?php echo site_url('rt/sktm/pdf/'.$sktm->id) ?>"
