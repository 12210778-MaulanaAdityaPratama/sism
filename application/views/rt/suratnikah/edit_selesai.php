<?php $this->load->view("rt/_partials/head.php") ?>
            ...
            <div id="layoutSidenav_content">
				...
				<div class="card mb-3">
					<div class="card-header">
						...
						<a href="<?php echo site_url('rt/suratnikah/') ?>"><i class="fas fa-arrow-left"></i>
							Back</a>
					</div>
					<div class="card-body">
    ...
    <option value="surat selesai" <?php echo ($suratnikah->status == 'surat selesai') ? 'selected' : ''; ?>>Surat Selesai</option>
                            ...
                            <?php if ($suratnikah->status == 'surat selesai'): ?>
    <div class="form-group mt-3">
    <a href="https://wa.me/<?php echo $suratnikah->telp; ?>" target="_blank" class="btn btn-success">Hubungi via WhatsApp</a>
    </div>
<?php endif; ?>
						</form>
						<?php else: ?>
							<?php redirect('rt/suratnikah'); ?>
<?php endif; ?>
